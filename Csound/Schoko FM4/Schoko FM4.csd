...
<Cabbage>
    ...
    ; Operator 1
    groupbox $GROUPBOX, bounds(10, 10, 710, 145), text("Operator 1") {
        ...
        checkbox $WIDGET, $CHECKBOX, bounds( 10, 100, 120, 15), channel("OP1_Output_Enable"),   text("Direct Output")
        checkbox $WIDGET, $CHECKBOX, bounds( 10, 120, 120, 15), channel("OP1_FM_Enable"),       text("Modulate Others")
        
        rslider  $WIDGET, $RSLIDER,  bounds(140,  30,  75, 75), channel("OP1_Feedback_Level"),  text("Feedback"),      range(0, 1, 0.0, 1, 0.01)
        rslider  $WIDGET, $RSLIDER,  bounds(210,  30,  75, 75), channel("OP1_Output_Level"),    text("Direct Output"), range(0, 1, 0.5, 1, 0.01)
        vslider  $WIDGET, $RSLIDER,  bounds(290,  32,  50, 90), channel("OP1_FM2_Level"),       text("OP2"),           range(0, 1, 0.5, 1, 0.01)
        vslider  $WIDGET, $RSLIDER,  bounds(320,  32,  50, 90), channel("OP1_FM3_Level"),       text("OP3"),           range(0, 1, 0.0, 1, 0.01)
        vslider  $WIDGET, $RSLIDER,  bounds(350,  32,  50, 90), channel("OP1_FM4_Level"),       text("OP4"),           range(0, 1, 0.0, 1, 0.01)
        ...
        checkbox $WIDGET, $CHECKBOX, bounds(310, 125,  10, 10), channel("OP1_FM2_Mod_Wheel")
        checkbox $WIDGET, $CHECKBOX, bounds(340, 125,  10, 10), channel("OP1_FM3_Mod_Wheel")
        checkbox $WIDGET, $CHECKBOX, bounds(370, 125, 120, 10), channel("OP1_FM4_Mod_Wheel"),   text("Mod. Wheel")
        ...
        nslider  $WIDGET, $NSLIDER,  bounds(520,  40,  75, 30), channel("OP1_Decay_Level"),     text("Decay"),         range(0, 1, 1.0, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(580,  40,  75, 30), channel("OP1_Sustain_Level"),   text("Sustain"),       range(0, 1, 1.0, 1, 0.01)
        ...
        nslider  $WIDGET, $NSLIDER,  bounds(520,  80,  75, 30), channel("OP1_Decay_Time"),      text("Seconds"),       range(0, 100, 0.0, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(580,  80,  75, 30), channel("OP1_Sustain_Time"),    text("Seconds"),       range(0, 100, 0.0, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(640,  80,  75, 30), channel("OP1_Release_Time"),    text("Seconds"),       range(0, 100, 0.2, 1, 0.01)
    }
    
    ; Operator 2
    groupbox $GROUPBOX, bounds(10, 165, 710, 145), text("Operator 2") {
        ...
        checkbox $WIDGET, $CHECKBOX, bounds( 10, 120, 120, 15), channel("OP2_FM_Enable"),       text("Modulate Others")
        ...
        vslider  $WIDGET, $RSLIDER,  bounds(320,  32,  50, 90), channel("OP2_FM3_Level"),       text("OP3"),           range(0, 1, 0.5, 1, 0.01)
        vslider  $WIDGET, $RSLIDER,  bounds(350,  32,  50, 90), channel("OP2_FM4_Level"),       text("OP4"),           range(0, 1, 0.0, 1, 0.01)
        
        nslider  $WIDGET, $NSLIDER,  bounds(140, 110,  75, 25), channel("OP2_Feedback_LFO"),    text("LFO"),           range(0, 1, 0, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(210, 110,  75, 25), channel("OP2_Output_LFO"),      text("LFO"),           range(0, 1, 0, 1, 0.01)
        checkbox $WIDGET, $CHECKBOX, bounds(340, 125,  10, 10), channel("OP2_FM3_Mod_Wheel")
        checkbox $WIDGET, $CHECKBOX, bounds(370, 125, 120, 10), channel("OP2_FM4_Mod_Wheel"),   text("Mod. Wheel")
    ...
    ; Operator 3
    groupbox $GROUPBOX, bounds(10, 320, 710, 145), text("Operator 3") {
        ...
        checkbox $WIDGET, $CHECKBOX, bounds( 10, 120, 120, 15), channel("OP3_FM_Enable"),       text("Modulate Others"), value(1)
        ...
        vslider  $WIDGET, $RSLIDER,  bounds(350,  32,  50, 90), channel("OP3_FM4_Level"),       text("OP4"),           range(0, 1, 0.5, 1, 0.01)
        
        nslider  $WIDGET, $NSLIDER,  bounds(145, 110,  75, 25), channel("OP3_Feedback_LFO"),    text("LFO"),           range(0, 1, 0, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(215, 110,  75, 25), channel("OP3_Output_LFO"),      text("LFO"),           range(0, 1, 0, 1, 0.01)
        checkbox $WIDGET, $CHECKBOX, bounds(370, 125, 120, 10), channel("OP3_FM4_Mod_Wheel"),   text("Mod. Wheel")
    ...
    ; Operator 4
    groupbox $GROUPBOX, bounds(10, 475, 710, 145), text("Operator 4") {
        ...
        checkbox $WIDGET, $CHECKBOX, bounds( 10, 100, 120, 15), channel("OP4_Output_Enable"),   text("Direct Output"), value(1)
        
        rslider  $WIDGET, $RSLIDER,  bounds(140,  30,  75, 75), channel("OP4_Feedback_Level"),  text("Feedback"),      range(0, 1, 0, 1, 0.01)
        rslider  $WIDGET, $RSLIDER,  bounds(210,  30,  75, 75), channel("OP4_Output_Level"),    text("Direct Output"), range(0, 1, 1, 1, 0.01)
        ...
        nslider  $WIDGET, $NSLIDER,  bounds(520,  40,  75, 30), channel("OP4_Decay_Level"),     text("Decay"),         range(0, 1, 0.8, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(580,  40,  75, 30), channel("OP4_Sustain_Level"),   text("Sustain"),       range(0, 1, 0.5, 1, 0.01)
        ...
        nslider  $WIDGET, $NSLIDER,  bounds(520,  80,  75, 30), channel("OP4_Decay_Time"),      text("Seconds"),       range(0, 100, 0.5, 1, 0.01)
        nslider  $WIDGET, $NSLIDER,  bounds(580,  80,  75, 30), channel("OP4_Sustain_Time"),    text("Seconds"),       range(0, 100, 0.3, 1, 0.01)
...
<CsoundSynthesizer>
    ...
    <CsInstruments>
        ...
        instr Read_Channels
            ...
            gk_OP1_FM2_Level         = lag(chnget:k("OP1_FM2_Level"),         i_Declick_ms)
            gk_OP1_FM3_Level         = lag(chnget:k("OP1_FM3_Level"),         i_Declick_ms)
            gk_OP1_FM4_Level         = lag(chnget:k("OP1_FM4_Level"),         i_Declick_ms)
            gk_OP1_FM2_Mod_Wheel     = lag(chnget:k("OP1_FM2_Level"),         i_Declick_ms)
            gk_OP1_FM3_Mod_Wheel     = lag(chnget:k("OP1_FM3_Mod_Wheel"),     i_Declick_ms)
            gk_OP1_FM4_Mod_Wheel     = lag(chnget:k("OP1_FM4_Mod_Wheel"),     i_Declick_ms)
            ...
            gk_OP2_FM3_Level         = lag(chnget:k("OP2_FM3_Level"),         i_Declick_ms)
            gk_OP2_FM4_Level         = lag(chnget:k("OP2_FM4_Level"),         i_Declick_ms)
            gk_OP2_FM3_Mod_Wheel     = lag(chnget:k("OP2_FM3_Mod_Wheel"),     i_Declick_ms)
            gk_OP2_FM4_Mod_Wheel     = lag(chnget:k("OP2_FM4_Mod_Wheel"),     i_Declick_ms)
            ...
            gk_OP3_FM4_Level         = lag(chnget:k("OP3_FM4_Level"),         i_Declick_ms)
            gk_OP3_FM4_Mod_Wheel     = lag(chnget:k("OP3_FM4_Mod_Wheel"),     i_Declick_ms)
        ...
        instr Tone_Generator, 1
            ...
            k_OP1_FM2_Level    = gk_OP1_FM_Enable     * gk_OP1_FM2_Level    ; TODO: Mod.Wheel
            k_OP1_FM3_Level    = gk_OP1_FM_Enable     * gk_OP1_FM3_Level
            k_OP1_FM4_Level    = gk_OP1_FM_Enable     * gk_OP1_FM4_Level
            ...
            k_OP2_FM3_Level    = gk_OP2_FM_Enable     * gk_OP2_FM3_Level    ; TODO: Mod.Wheel
            k_OP2_FM4_Level    = gk_OP2_FM_Enable     * gk_OP2_FM4_Level
            ...
            k_OP3_FM4_Level    = gk_OP3_FM_Enable     * gk_OP3_FM4_Level    ; TODO: Mod.Wheel
            ...
            a_OP2 FMOperator  (a_OP1 * k_OP1_FM2_Level),                     \
                              k_OP2_Frequency,                               \
                              k_OP2_Feedback,                                \
            ...
            a_OP3 FMOperator  (a_OP1 * k_OP1_FM3_Level) + (a_OP2 * k_OP2_FM3_Level), \
                              k_OP3_Frequency,                               \
                              k_OP3_Feedback,                                \
            ...
            a_OP4 FMOperator  (a_OP1 * k_OP1_FM4_Level) + (a_OP2 * k_OP2_FM4_Level) + (a_OP3 * k_OP3_FM4_Level), \
                              k_OP4_Frequency,                               \
                              k_OP4_Feedback,                                \
